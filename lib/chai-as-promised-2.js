(function (chaiAsPromised) {
    ...
    getterNames.forEach(function (getterName) {
        ...
        if (isChainableMethod) {
            Assertion.addChainableMethod(
                ...
                function () {
                    var assertion = this;
                    var originalMethod = function () { return propertyDesc.get.call(assertion).apply(assertion, arguments); };
                    doAsserterAsyncAndAddThen(originalMethod, this, arguments);
                },
                function () {
    ...
    function doAsserterAsyncAndAddThen(asserter, assertion, args) {
        ...
        var basePromise = typeof assertion.then === "function" ? assertion : assertion._obj;

        var derivedPromise = basePromise.then(function (value) {
    ...
    assert.isRejected = function (promise, toTestAgainst, message) {
        ...
        return toTestAgainst ? assertion.to.be.rejectedWith(toTestAgainst) : assertion.to.be.rejected;
    };
    ...
    originalAssertMethods.forEach(function (assertMethodName) {
        assert.eventually[assertMethodName] = function (promise) {
            ...
            return promise.then(function (fulfillmentValue) {

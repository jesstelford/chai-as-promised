(function (chaiAsPromised) {
    ...
    function doAsserterAsyncAndAddThen(asserter, assertion, args) {
        // Since we're intercepting all methods/properties, we need to just pass through if they don't want `eventually`.
        if (!utils.flag(assertion, "eventually")) {
            return asserter.apply(assertion, args);
        }

        var obj = utils.flag(assertion, "object");
        var derivedPromise = obj.then(function (value) {
